...
## Derleme — geliştirme tamamlandıktan sonra
...
`.github/workflows/build.yml` macOS derleme kontrolünü tanımlar. Bu Windows oturumunda Xcode bulunmadığı için **henüz derleme, simülatör veya fiziksel iPhone testi yapılmadı**. Kaynaklar şu an tam ürün adayıdır; çalışan uygulama olarak doğrulanmış değildir.
...
1. macOS/Xcode derlemesi ve birim testleri; varsa derleyici hatalarının düzeltilmesi.
2. Gerçek iPhone'da hesap, çevrimdışı kayıt, iki cihaz arasında eşitleme, veri dışa aktarma ve hesap silme.
3. Desteklenen kartla gerçek Wallet temassız işlemi; Kestirmeler girdi eşleme, yinelenen işlem ve bildirim denemesi.
4. Erişilebilirlik, açık/koyu görünüm ve animasyonların gerçek ekran incelemesi.
5. [Gizlilik metni](docs/PRIVACY.md) ve [App Store taslağındaki](docs/STORE.md) yayın bilgileri, TestFlight ve App Store incelemesi.
